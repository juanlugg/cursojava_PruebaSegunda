 ...
 * Clase Servlet que gestionará el añadir un producto
 */
public class AddServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<title>Añadiendo Producto</title>");
		out.println("</head>");
		...
		try {
			...
			if (idExiste) {
				out.println("<h3 align='center' style='color:red;'>EL ID [" + id + "] YA ESTA ASOCIADO A OTRO PRODUCTO</h3>");
			} else {
